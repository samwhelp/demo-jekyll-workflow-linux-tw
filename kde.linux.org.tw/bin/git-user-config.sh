...
THE_GIT_USER_NAME=yourname
THE_GIT_USER_EMAIL=yourname@users.noreply.github.com
...
git config user.name $THE_GIT_USER_NAME
git config user.email $THE_GIT_USER_NAME
